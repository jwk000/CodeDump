...
namespace GYXMLData
{
        ...
        public bool Parse(XmlNode node)
        {
            ...
            }
            {
                ...
                foreach(XmlNode n in child_node)
                {
                    ...
                    {
                        pop_tip_list.Add(string.Parse(n.InnerText));
                    }
                }
            }
            {
    ...
    {
        public int garden_guide_seed_id = ; 
        public int garden_per_seed_harvest_num = ; 
        public int garden_synthetic_flower_per_need = ; 
        public List<flower> garden_synthetic_flower_list = new List<flower>(); 
        public List<item> collection_position_config = new List<item>(); 
        public int forge_product_id_boy = ; 
        public int forge_product_id_girl = ; 
